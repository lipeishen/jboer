...
$(document).ready(function(){
	...
	$("#datagrid").datagrid({
		method:"post",
		url:"<%=path%>/cacheSystem/country/getListInCountryList.do",
		...
		columns:[[
			{title:"县编码",field:"country_code",width:"45%",align:"center"},
			{title:"县名称",field:"country_name",width:"53%",align:"center"}
		]]
	});
});

var refreshCountryCache = function(){
	$("#datagrid").datagrid({
		method:"post",
		url:"<%=path%>/cacheSystem/country/refreshCountryCache.do",
		title:"",iconCls:"icon-save",pagination:"true",
		pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20],striped:"true",fitColumns:"true",nowrap:"true",singleSelect:"true",
		rownumbers:"true",border:"true",idField:"id",height:400,
		columns:[[
	...
	<table style="width: 100%;margin-bottom:10px;">
		<tr>
			<td style="font-size: 12px;width: 30%;text-align:center;" colspan="2">
				<a href="javascript:void(0)" style="float:right;margin-right:10px;" class="standard-button" onclick="refreshCountryCache()">刷新缓存</a>
			</td>
		</tr>
	</table>
