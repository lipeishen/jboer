...
$(document).ready(function(){
	...
	$("#datagrid").datagrid({
		method:"post",
		url:"<%=path%>/cacheSystem/province/getListInProvinceList.do",
		...
		columns:[[
			{title:"省编码",field:"province_code",width:"45%",align:"center"},
			{title:"省名称",field:"province_name",width:"53%",align:"center"}
		]]
	});
});

var refreshProvinceCache = function(){
	$("#datagrid").datagrid({
		method:"post",
		url:"<%=path%>/cacheSystem/province/refreshProvinceCache.do",
		title:"",iconCls:"icon-save",pagination:"true",
		pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20],striped:"true",fitColumns:"true",nowrap:"true",singleSelect:"true",
		rownumbers:"true",border:"true",idField:"id",height:400,
		columns:[[
	...
	<div class="biaodan-content-List">
		...
		<tr>
			<td style="font-size: 12px;width: 30%;text-align:center;" colspan="2">
				<a href="javascript:void(0)" style="float:right;margin-right:10px;" class="standard-button" onclick="refreshProvinceCache()">刷新缓存</a>
			</td>
		</tr>
	</table>
